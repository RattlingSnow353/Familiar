local con_man = {
    ...
    loc_txt = {
        ['en-us'] = {
            name = 'Con Man',
            text = {
                "Takes {C:money}$#1#{} to create",
                "a copy of one a random {C:attention}Joker{}",
                "or {C:tarot}Consumable{} at the end of a shop",
                "Price increases by {C:money}$2{} every activation",
